...
class CafeManagementApplicationTests {
	...
	public void testSignUp_Success() {
		...
		Mockito.when(cafeHelper.valiidateSignUp(requestMap)).thenReturn(true);
		Mockito.when(userRepository.findByEmailId("test@example.com")).thenReturn(null);
	...
	public void testSignUp_UserPresent() {
		...
		Mockito.when(cafeHelper.valiidateSignUp(requestMap)).thenReturn(true);
		Mockito.when(userRepository.findByEmailId("test@example.com")).thenReturn(new User());
	...
	public void testSignUp_InvalidData() {
		...
		Mockito.when(cafeHelper.valiidateSignUp(requestMap)).thenReturn(false);
	...
	public void testSignUp_Exception() throws RuntimeException {
		...
		Mockito.when(cafeHelper.valiidateSignUp(requestMap)).thenThrow(new RuntimeException());
